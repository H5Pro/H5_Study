...
const DEFALUT_INPUT_HEIGHT = 30
const DEFAULT_CANCELBUTTON_HEIGHT = 40
const DEFAULT_CANCELBUTTON_WIDTH = 70
class BMSearchBar extends PureComponent {
  constructor(props) {
    super(props);
    ...
    this.cancelButtonWidth = this.props.cancelButtonWidth || DEFAULT_CANCELBUTTON_WIDTH
    this.cancelButtonHeight = this.props.cancelButtonHeight || DEFAULT_CANCELBUTTON_HEIGHT
    /**
     * Animated values
     */
     ...
     * local variables
     */
    this.placeholder = this.props.placeholder || 'BMSearchBar';
  ...
  onDelete = async () => {
    ...
    this.props.onChangeText && (await this.props.onChangeText(''))
        ...
        >
          <Animated.View
            style={[
              ...
              {
                width: this.cancelButtonWidth,
                height: this.cancelButtonHeight
              }
...
const getStyles = (inputHeight, isRtl) => {
  ...
  return {
    ...
    iconDelete: {
      position: 'absolute',
      right: DEFAULT_CANCELBUTTON_WIDTH,
      margin: 'auto',
      height: 14,
      width: 14
    },
    ...
    cancelButton: {
      ...
      height: DEFAULT_CANCELBUTTON_HEIGHT
    },
    cancelButtonText: {
      fontSize: 14,
      color: '#fff'
