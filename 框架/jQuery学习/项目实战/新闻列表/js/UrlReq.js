...
UrlReq.XHR = function(type,method,paramStr,success){
    ...
    var baseUrl = UrlReq.baseUrl + UrlReq[methodType];
    UrlReq.XHR_CORE(type,baseUrl,method,paramStr,success);
}
...
/**
 * 公共请求方法(核心部分)
 * @param type 1:GET; 2:POST; 3:GET_O;  4:POST_O
 * @param baseUrl
 * @param method
 * @param paramStr
 * @param success
 * @constructor
 */
UrlReq.XHR_CORE = function(type,baseUrl,method,paramStr,success){
