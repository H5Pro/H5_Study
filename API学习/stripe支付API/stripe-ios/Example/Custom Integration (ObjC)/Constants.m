...
NSString *const StripePublishableKey = @"pk_test_O5N1418rxpxfcnHoklRxZvNJ"; // nil; // TODO: replace nil with your own value
...
NSString *const BackendBaseURL = @"https://stripe-backend-ruby.herokuapp.com/"; // TODO: replace nil with your own value
